"""
Django settings for alhbret project.
...
SECRET_KEY = '5n^n*p1q+2x%6m#b0u4utmotr$)7(=n!31-y(*z-)rwsz(77et'
...
WSGI_APPLICATION = 'alhbret.wsgi.application'
